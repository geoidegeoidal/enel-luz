...
const browser = await puppeteer.launch({
  ...
  headless: 'new',
  args: ['--no-first-run', '--window-size=390,844'],
...
await page.screenshot({ path: OUT + 'mobile_initial.png' })
...
await page.screenshot({ path: OUT + 'mobile_charts.png' })
...
await page.screenshot({ path: OUT + 'mobile_diag.png' })
